 ...
 * @details Files saved on the internal/external storage are readable or writable by all applications.
...
/**
 * @brief Registers a callback function to be invoked when a certain type of storage states are changed.
 *
 * @since_tizen 3.0
 *
